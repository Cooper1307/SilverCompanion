...
* **平台选择**：**阿里云百炼 (Alibaba Bailian)**。
* **核心大模型**：**Qwen3-Max (千问3-Max，2025年9月发布)**。
* **选择理由**：
    1. **中文理解与多模态天花板**：Qwen3-Max作为2025年最新的万亿参数模型，在中文逻辑推理及医学长文本理解上表现卓越，且具备Qwen3-Omni的多模态能力，未来可扩展“看图片识别药品”功能。
    2. **数据安全与合规**：完全符合《生成式人工智能服务管理暂行办法》，数据存储在阿里云上海节点，满足本地化合规要求，适合高校项目展示。
    3. **生态完善**：原生支持 Qwen-TTS 的高质量中文语音合成，可生成亲切、自然的播音员级别语音，确保老人听得清、听得懂。
...
2. **知识库构建（核心）**：整理了约2万字的上海养老政策及康复护理文档，利用我校护理学院资源进行专业性校验。
3. **Prompt调试**：重点打磨“共情能力”，让AI学会“先安抚，后建议”的话术逻辑。
4. **Bad Case修复**：针对“语音识别干扰”和“幻觉医疗建议”进行专项优化。
